...
#define GR1_WIND_SCALING_RATIO 0.45 //GR1 is the very high surface area fuel that is extremely sensitive to wind speed
#define GR1_SLOPE_SCALING_RATIO 0.45
